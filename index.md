...
<img style="width: 75%; max-width: 1360px; display: block; margin: 12px; border: 1px solid black;" alt="GitHub Pull Request checks screen" src="assets/quickstart-app-entry.png" />  
