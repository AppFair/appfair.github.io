...
The experimental <a name="altore">iOS catalog</a> is available at: [https://www.appfair.net/fairapps-iOS.json](altstore://source?url=https://www.appfair.net/fairapps-iOS.json).
